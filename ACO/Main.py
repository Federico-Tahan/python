...
while opcion != 4:
    ...
    if opcion == 1:
        print()
        print("=" *50)
        print("\tProcesamiento de decimal a Hexadecimal")
        print("=" * 50)
        print()
        cont = 0
        ant = num = ""
        resultado = ""
        cociente_hexa = int(input("Ingrese el numero entero: "))
        ...
        print("El resultado de base 10 a Hexadecimal es:", numero_convertido)
    elif opcion == 2:
        print()
        print("=" *50)
        print("\tProcesamiento de decimal a Binario")
        print("=" * 50)
        print()
        ant = num = ""
        resultado = ""
        ...
        print("El resultado de base 10 a binario es:", dado_vuelta,".",enteros)

    elif opcion == 3:
        print()
        print("=" *50)
        print("\tProcesamiento de decimal a octal")
        print("=" * 50)
        print()

        c = oct(int(input("Ingrese el numero en decimal para convertilo en octal")))
        ...
        print("El resultado de base 10 a octal es:", c, ".", enteros)
    else:
